...
ax_3.set_xlabel('Conf_1 binding affinity  (kcal/mol)')
ax_3.set_ylabel('Conf_2 binding affinity  (kcal/mol)')
ax_3.set_zlabel('Probability density')

# 在3D图形底面投影二维轮廓
# contour = ax.contour(x_grid, y_grid, hist.T, zdir='z', offset=-600, cmap='coolwarm', linewidths=1)
# 在3D图形底面投影二维轮廓并填充轮廓
contour_2 = ax_3.contourf(x_grid_2, y_grid_2, hist_2.T, zdir='z', offset=-0.5, cmap='coolwarm', levels=20, alpha=0.8, vmin=0, vmax=2.0)
