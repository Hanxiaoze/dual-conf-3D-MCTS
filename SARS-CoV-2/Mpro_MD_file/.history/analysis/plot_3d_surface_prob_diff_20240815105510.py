...
surf = ax.plot_surface(x_grid, y_grid, hist.T, color='orange', rstride=1, cstride=1, antialiased=True, alpha=0.9)
...
# 使用plot_surface绘制平滑曲面图
# surf_2 = ax.plot_surface(x_grid_2, y_grid_2, hist_2.T, color='cyan', rstride=1, cstride=1, antialiased=True, alpha=0.4)
