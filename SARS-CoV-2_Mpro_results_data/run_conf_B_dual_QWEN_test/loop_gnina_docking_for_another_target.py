...
lig_dir = './run_conf_A_dual_QWEN_test/record'
pro_dual_pdb = './conf_B_4240.pdb'
ligand_box_dual = './ligand_B_s.sdf'

pro_dual_pdbqt = './conf_B_4240.pdbqt'
...
if __name__ == "__main__":
    ...
    for lig_sdf in sorted_lig_sdf_list[143: ]:
        # print(lig_sdf)
